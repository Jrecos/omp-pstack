...
> Source material for the runner's triage run. The native runner loads the committed operational file directly; this template documents the run's shape for setup and review.

Read and follow `.omp/automations/benny/skills/triage-issue-reports/SKILL.md` for this run.
