...
Copy this file outside `.omp/automations/benny/`, for example to `.omp/benny/feature-map.md`, and set `control.feature_map_path` to the copy. Pack refreshes must not overwrite it.
