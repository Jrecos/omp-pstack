...
- `Read` tool calls against any `SKILL.md` file (project `.agents/skills/` or `.omp/skills/`, user-level profile `skills/`, or plugin-installed packages)
- native `task` prompts that name a skill path
