...
export interface WaitingDecision {
  ...
  /**
   * Pending checks on the frontier PR, or null when GitHub has not computed
   * mergeability yet (`mergeable: "UNKNOWN"`). Null is an explicit
   * nonterminal wait, never readiness proof.
   */
  readonly pending: NonEmpty<PendingCheck> | null;
}
